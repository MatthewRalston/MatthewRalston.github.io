...
<!-- Generated by chatGPT 4o mini : I believe the algorithm for testing the prime number by checking factors up to the int square root is called the sieve of Eratosthenes -->
```python
