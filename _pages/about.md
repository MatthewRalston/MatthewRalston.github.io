...
And I must insist you understand that I'm a bench scientist too! Apart from collaborating in group standups, breakout meetings, or quarterly huddles, I work independently and in teams to achieve progress for my managers yearly and quarterly activities, sprints, stories, experiments, tests, and validations, as well as performance, cultural, and psychosocial corporate endpoints. 
  ...
  * Passion:
  ...
  I get genuine satisfaction from writing open-source code, algorithms, and pipelines. Scripts, APIs, websites, and databases are rapid turn-around deliverables in my perspective. Possessing a well-rounded STEM background, I bring expertise in diverse areas such as biological networks (metabolomics, transcriptomics, and genomics), mathematical and statistical theory, and nuanced experimental considerations including the biophysical origins of artifacts. Furthermore, I excel in modeling error, probability assessment, and programming design patterns. If you seek more than just a proficient coder, I strongly encourage you to delve deeper into my profile to discover the breadth of my capabilities.
  
  <!-- I have a balanced STEM background that includes biological networks (metabolomics, transcriptomics, and some human and non-human genomics), math/stats theory, even nuanced experimental concerns like the biophysical origin of artifacts, as well as modeling error, probability, and programming design patterns. If you want more than a coder, then I must passionately emphasize you read on to find out more. -->
...
>  I'm more than just a wet-bench professional turned programmer. I'm your team's next valued member.
